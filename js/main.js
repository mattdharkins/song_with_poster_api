...
// Function gets song from spotify using the image index in our gallery
// Then it finds the correct item_index of the JSON response object from Spotify.
// This will produce a preview url
...
async function clickedEvent(img_index, item_index){
    ...
    //TODO: Add songSnippet function to play song from the preview_url
    if (playSong){
        stopSnippet();
    }
    songSnippet(song)
